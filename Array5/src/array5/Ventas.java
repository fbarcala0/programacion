...
public class Ventas {
    /*Primero de todo se le añaden las propiedades*/
        ...
        /**
         * Constructor que inicializa el año con parametro y el vector con 
        ...
        /**
         * Función que devuelve la media de valores del vector
         * @param media . La media de los valores del vector
         * @return media
         */
        ...
        /**
         * Función para ejecutar un gráfico que por cada 100 unidades ponga una "#"
         */
        public void grafica(){
        /*Para la grafica, debemos primero recorrer con el bucle las posiciones
        del vector e ir añadiendo el mes*/
            for(int i = 0; i < this.vector.length; i++){
                System.out.printf("Mes %d (%d): ", i+1,this.vector[i]);
